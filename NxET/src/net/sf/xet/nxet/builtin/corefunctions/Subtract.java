...
/**
 * Subtract function subtracts<br>
 * <br>
 * - parameter number2 "from"<br>
 ...
 * can be subtracted successfully. Otherwise, 
 * it will return FALSE.<br>
 * <br>
 * The Subtract built-in can be used as a D-atom 
 * or an N-atom.
 * 
...
public class Subtract extends Builtin {
     ...
     */
    public Subtract(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public Subtract(Node builtinAtom, World world, Integer place) {
     ...
     * or not<br>
     * <br>
     * This built-in function requires<br>
     * - parameter number1<br>
     ...
     * checked.<br>
     * <br>
     * This built-in functions will be executable if the following
