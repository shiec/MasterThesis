 ...
 */
public class NumberEqual extends Builtin {
     ...
     */
    public NumberEqual(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public NumberEqual(Node builtinAtom, World world, Integer place) {
     ...
     * or not<br>
     * <br>
     * This function requires that there are two parameters:<br>
     ...
     * (equal). If two numbers cannot be compared,
