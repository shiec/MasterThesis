...
public class Not extends Builtin {
     ...
     */
    public Not(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public Not(Node builtinAtom, World world, Integer place) {
    ...
    public ExecutionResult execute() throws NotExecutableException {
        ...
        ExecutionResult execResult = builtinMan.executeBuiltin(builtinAtom.childNode(0), this.place);
        execResult.setSuccess(!execResult.isSuccess());
        return execResult;
    }
