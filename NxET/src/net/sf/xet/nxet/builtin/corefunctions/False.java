...
public class False extends Builtin {
     ...
     */
    public False(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public False(Node builtinAtom, World world, Integer place) {
     ...
     * checked.<br>
     * <br>
     * This built-in function will always be executable.
     * 
    ...
    /**
     * The built-in always return FALSE execution success 
     * result.
     * 
