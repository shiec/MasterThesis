 ...
 * <br>
 * - parameter number1 *is greater than or equal to*<br>
...
public class GreaterThanOrEqual extends Builtin {
     ...
     */
    public GreaterThanOrEqual(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public GreaterThanOrEqual(Node builtinAtom, World world, Integer place) {
     ...
     * (greater than or equal to). If two numbers 
     * cannot be compared, the numbers cannot be parsed), 
