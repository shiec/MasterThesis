...
/**
 * CountMember checks the number of members of an E-variable
 * 
 * @author Paramai Supadulchai
 */
public class CountMember extends Builtin {
     ...
     */
    public CountMember(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public CountMember(Node builtinAtom, World world, Integer place) {
    ...
    public ExecutionResult execute() throws NotExecutableException {
        ...
        int result = builtinAtom.numberOfChildNodes();
		Specialization spec = new Specialization();
		spec.addSpecialization(resultVariable, Integer.toString(result));
