...
public class SetInMemoryObject extends Builtin {
	...
	public ExecutionResult execute() throws NotExecutableException {
		...
		String value = builtinAtom.attributeByLocalName(ATTR_VAL)
				.getNodeValue();
		String result = builtinAtom.attributeByLocalName(ATTR_RESULT)
				.getNodeValue();

		InMemoryObjects.XETMEMORYOBJECT.put(key, value);

		spec.addSpecialization(result, InMemoryObjects.XETMEMORYOBJECT
				.get(builtinAtom.attributeByLocalName(ATTR_KEY)));
