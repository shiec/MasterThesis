 ...
 * <br>
 * - parameter number1 *is greater than*<br>
 * - parameter number2<br>
 * <br>
 * The execution result' success is TRUE when 
 * number1 is greater than number2. Otherwise, 
...
public class GreaterThan extends Builtin {
     ...
     */
    public GreaterThan(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public GreaterThan(Node builtinAtom, World world, Integer place) {
     ...
     * (greater than). If two numbers cannot be compared,
