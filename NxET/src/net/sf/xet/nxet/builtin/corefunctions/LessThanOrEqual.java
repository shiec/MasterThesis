...
public class LessThanOrEqual extends Builtin {
     ...
     */
    public LessThanOrEqual(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public LessThanOrEqual(Node builtinAtom, World world, Integer place) {
     ...
     * (less than or equal to). If two numbers cannot 
     * be compared, (the numbers cannot be parsed), 
