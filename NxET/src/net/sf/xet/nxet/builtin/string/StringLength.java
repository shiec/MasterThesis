 ...
 */
public class StringLength extends Builtin {
     ...
     */
    public StringLength(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public StringLength(Node builtinAtom, World world, Integer place) {
    ...
    public ExecutionResult execute() throws NotExecutableException {
		...
		int result = originalString.length();
        ...
        execResult.setResultDescription(" [" + resultVariable + " <- " + 
										result + " = StringLength(\"" + originalString + "\")]");
	    return execResult;
    }
