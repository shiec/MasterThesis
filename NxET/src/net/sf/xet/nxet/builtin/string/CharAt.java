 ...
 */
public class CharAt extends Builtin {
     ...
     */
    public CharAt(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public CharAt(Node builtinAtom, World world, Integer place) {
    ...
    public ExecutionResult execute() throws NotExecutableException {
		...
		String result = Character.toString(originalString.charAt(index));
