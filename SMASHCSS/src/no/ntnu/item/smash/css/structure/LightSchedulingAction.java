...
public class LightSchedulingAction extends DecidedAction {
	...
	public LightSchedulingAction() {
		
	}
	
	public LightSchedulingAction(Entity room, ComfortMeasure measure, Object value, Date time, String lightName) {
		this.room = room;
