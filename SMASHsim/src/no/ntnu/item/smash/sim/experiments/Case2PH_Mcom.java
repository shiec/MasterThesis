...
public class Case2PH_Mcom {
	...
	public static void main(String[] args) {
		...
		DSO.setContractType(0); // 0=DLC, 1=ULC
		String[] dlcDevs = {"whBath1"};
		DSO.setDLCControllableDevices(dlcDevs);
		DSO.addControlRequest("212010", new DLCRequest(whBath1, 24*1 + 17, 24*1 + 19, 30, 10));
		DSO.addControlRequest("1312010", new DLCRequest(whBath1, 24*12 + 17, 24*12 + 19, 30, 10));
		...
		int id = context.getPgc().registerPolicy("Y:/Workspaces/SMASH/SMASHCSS/policies/p1_priceCom.xet.xml", "comfort");
		...
		sim.startSimulation(simTime, 1, 1, 2010, "experiments/Case2PH_Mcom");
	}
