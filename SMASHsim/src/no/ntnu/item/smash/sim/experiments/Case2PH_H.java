...
public class Case2PH_H {
	...
	public static void main(String[] args) {
		...
		int id = context.getPgc().registerPolicy("D:/Java/kepler/workspace/SMASHCSS/policies/p1_price.xet.xml", "cost");
		...
		sim.startSimulation(simTime, 1, 1, 2010, "experiments/Case2PH_H");
	}
