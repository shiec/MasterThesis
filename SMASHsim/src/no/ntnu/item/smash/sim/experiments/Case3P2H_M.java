...
public class Case3P2H_M {
	...
	public static void main(String[] args) {
		...
		int id = context.getPgc().registerPolicy("Y:/Workspaces/SMASH/SMASHCSS/policies/p3_ulc.xet.xml", "cost");
		ExternalEventTrigger trigger = new ExternalEventTrigger(Trigger.TYPE_EXTERNAL_EVENT, Trigger.COND_EQUALTO, "DSO");
		int id2 = context.getPgc().registerPolicy("Y:/Workspaces/SMASH/SMASHCSS/policies/p1_price.xet.xml", "cost");
		...
		sim.startSimulation(simTime, 1, 1, 2010, "experiments/Case3P2H_M");
	}
