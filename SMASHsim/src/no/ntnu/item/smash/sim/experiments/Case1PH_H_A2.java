...
public class Case1PH_H_A2 {
	...
	public static void main(String[] args) {
		...
		int id = context.getPgc().registerPolicy("Y:/Workspaces/SMASH/SMASHCSS/policies/p1_price_A2.xet.xml", "cost");
		...
		sim.startSimulation(simTime, 1, 1, 2010, "experiments/Case1PH_H_A2");
	}
