...
public class Case3P2_washing {
	...
	public static void main(String[] args) {
		...
		double[] wmSchedule = {0,0,0,17.833,0,0,17.833};
		...
		int id = context.getPgc().registerPolicy("C:/Users/shuna/workspace/SMASHCSS/policies_add/pwm_price.xet.xml", "comfort");
		...
		sim.startSimulation(simTime, 1, 1, 2010, "experiments1/washing/Case3P2_washing");
	}
